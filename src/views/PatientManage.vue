 ...
 * @LastEditTime: 2025-02-26 03:14:18
 * @Description: 
-->
<template>
            ...
            <el-row>
                ...
                <el-col :span="13">
                    <el-form label-width="100px" class="emo-form-inline">
                        <el-form-item label="病例编号">
                            <el-input clearable v-model="requestConfig.form.id" placeholder="请输入病例编号"></el-input>
                        </el-form-item>
                        <el-form-item label="病人姓名">
                            <el-input clearable v-model="requestConfig.form.name" placeholder="请输入病人姓名"></el-input>
                        </el-form-item>
                    </el-form>
                </el-col>
                <el-col :span="4">
                ...
                <el-col :span="4">
                    <div class="pull-right">
                        <el-button @click="handleAdd" type="danger" :icon="Plus">添加病患</el-button>
                    </div>
                </el-col>
            </el-row>
        </div>
    ...
    <el-dialog :title="dialogTitle" v-model="dialogVisible" :close-on-click-modal="false" @close="closeDialog"
        ...
        <el-form :model="dialogConfig" ref="formRef" label-width="120px">
            <el-form-item label="病例编号" prop="id" v-if="isEditModel">
                <el-input v-model="dialogConfig.id" placeholder="请输入病例编号" class="input-field" disabled></el-input>
            </el-form-item>
            <el-form-item label="病人姓名" prop="name">
                <el-input v-model="dialogConfig.name" placeholder="请输入病人姓名" class="input-field"></el-input>
            </el-form-item>
            <el-form-item label="性别" prop="gender">
                <el-select v-model="dialogConfig.gender" placeholder="请选择性别" class="input-field">
                    <el-option label="男" value="男"></el-option>
                    <el-option label="女" value="女"></el-option>
                </el-select>
            </el-form-item>
            <el-form-item label="出生日期 :">
                <el-date-picker v-model="dialogConfig.birthDate" type="datetime" placeholder="选择日期时间"
                    format="YYYY-MM-DD HH:mm:ss" value-format="YYYY-MM-DD HH:mm:ss" :clearable="true">
                </el-date-picker>
            </el-form-item>
            <el-form-item label="联系电话" prop="phone">
                <el-input v-model="dialogConfig.phone" placeholder="请输入联系电话" class="input-field"></el-input>
            </el-form-item>
            <el-form-item label="住址" prop="address">
                <el-input v-model="dialogConfig.address" placeholder="请输入住址" class="input-field"></el-input>
            </el-form-item>
...
const handleEdit = (id, data) => {
    ...
    dialogConfig.birthDate = data.birthDate;
...
const doAddOrEdit = () => {
    if (isEditModel.value) {
        //编辑模式
        let url_param = constant.patient.updateUrl;
        ...
        //添加模式
        let url_param = constant.patient.addUrl;
        let data_param = dialogConfig;
...
const handleDelete = (id) => {
    console.log("删除", id);
    doDeleteRequest(constant.patient.deleteUrl, id).then((res) => {
        console.log(res);
        if (res.data.code === 200) {
            ElMessage({
                message: "删除成功",
...
const delBatch = () => {
    ...
    if (delIds.length == 0) {
        ...
        doPostRequest(constant.patient.deleteBatchUrl, delIds).then(
            (res) => {
                console.log(res);
                if (res.data.code === 200) {
                    ElMessage({
...
const searchData = () => {
    ...
    if (isInput) {
        searchOrGetRequest(
            constant.patient.searchOrGetPageList,
            page_parm,
            data_param
        ).then((res) => {
            if (res.data.code === 200) {
