 ...
 * @LastEditTime: 2025-03-18 13:11:29
 * @Description: 
-->
<template>
            ...
            <el-row>
                ...
                <el-col :span="13">
                    <el-form label-width="100px" class="emo-form-inline">
                        <el-form-item label="资讯ID">
                            <el-input clearable v-model="requestConfig.form.id" placeholder="请输入资讯ID"></el-input>
                        </el-form-item>
                        <el-form-item label="资讯标题">
                            <el-input clearable v-model="requestConfig.form.title" placeholder="请输入资讯标题"></el-input>
                        </el-form-item>
                    </el-form>
                </el-col>
                <el-col :span="4">
                ...
                <el-col :span="4">
                    <div class="pull-right">
                        <el-button @click="handleAdd" type="danger" :icon="Plus">添加资讯</el-button>
                    </div>
                </el-col>
            </el-row>
        </div>
    ...
    <el-dialog :title="dialogTitle" v-model="dialogVisible" :close-on-click-modal="false" @close="closeDialog"
        ...
        <el-form :model="dialogConfig" ref="formRef" label-width="120px">
            <el-form-item label="资讯ID" prop="id" v-if="isEditModel">
                <el-input v-model="dialogConfig.id" placeholder="请输入资讯ID" class="input-field" disabled></el-input>
            </el-form-item>
            <el-form-item label="资讯标题" prop="title">
                <el-input v-model="dialogConfig.title" placeholder="请输入资讯标题" class="input-field"></el-input>
            </el-form-item>
            <el-form-item label="资讯内容" prop="content">
                <el-input v-model="dialogConfig.content" placeholder="请输入资讯内容" class="input-field"></el-input>
            </el-form-item>
            <el-form-item label="来源" prop="source">
                <el-input v-model="dialogConfig.source" placeholder="请输入来源" class="input-field"></el-input>
            </el-form-item>
...
const handleEdit = (id, data) => {
    ...
    dialogConfig.content = data.content;
    dialogConfig.source = data.source;
...
const doAddOrEdit = () => {
    if (isEditModel.value) {
        //编辑模式
        let url_param = constant.article.updateUrl;
        ...
        //添加模式
        let url_param = constant.article.addUrl;
        let data_param = dialogConfig;
...
const handleDelete = (id) => {
    console.log("删除", id);
    doDeleteRequest(constant.article.deleteUrl, id).then((res) => {
        console.log(res);
        if (res.data.code === 200) {
            ElMessage({
                message: "删除成功",
...
const delBatch = () => {
    ...
    if (delIds.length == 0) {
        ...
        doPostRequest(constant.article.deleteBatchUrl, delIds).then(
            (res) => {
                console.log(res);
                if (res.data.code === 200) {
                    ElMessage({
...
const searchData = () => {
    ...
    if (isInput) {
        searchOrGetRequest(
            constant.article.searchOrGetPageList,
            page_parm,
            data_param
        ).then((res) => {
            if (res.data.code === 200) {
